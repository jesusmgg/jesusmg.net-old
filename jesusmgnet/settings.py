"""
Django settings for jesusmgnet project.
...
SECRET_KEY = 'm_2-!had(p&b5&9ob5x@(ou18(q%vu13-u+-wpna+5$+4r4%4='
...
WSGI_APPLICATION = 'jesusmgnet.wsgi.application'
